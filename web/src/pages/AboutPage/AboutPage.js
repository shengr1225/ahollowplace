...
const AboutPage = () => {
  return (
    <Box>
      ...
      >
        <StyleHeader isHome={true} />
      </Box>

      <div className="flex flex-row flex-wrap lg:flex-nowrap text-center mt-16">
        <div className="basis-full lg:basis-1/3">
          ...
          <div
            ...
            style={meBGStyle}
          />
          <div className="py-6 leading-8 px-12">
            <Heading
              as="em"
              fontSize="lg"
            ...
            <Text textAlign="left" className="py-6">
              ...
              老鸭粉丝汤, 重庆酸辣粉也成为了平台的流量密码。 疫情是我们的红利期,
              但是产品逐渐成为了瓶颈, 用户留存一直提不上去, 每天还要炒菜,
              宣传和送餐, 顾此失彼导致了产品一直没时间优化,
              团队管理经验的缺失导致了这次创业的失败。
            ...
            <p className="pt-8 pb-12">下面就是洞屋剧本杀的前世今生了...</p>
          </div>
        </div>
        <div className="basis-full lg:basis-1/3">
          <Heading className="text-lg font-light py-8 lg:pt-0">
            Short Story
          </Heading>
          <Heading
            fontSize="lg"
          ...
          <div className="pt-8 px-8 leading-8 text-center">
            <Text textAlign="left">
            ...
            <div
              className="rounded w-64 h-48 mx-auto my-8"
              style={dongwuBGStyle}
            />
            <Heading
              fontSize="lg"
            ...
            <Text textAlign="left" className="py-8">
            ...
            <div
              ...
              style={food1BGStyle}
            />
            <Text className="py-6" textAlign="left">
        ...
        <div className="basis-full lg:basis-1/3 text-center">
          <Heading className="font-light" pb="8">
            Long Story
          </Heading>
          <Heading
            fontSize="lg"
          ...
          <Text className="py-8 px-8 leading-8 text-left">
