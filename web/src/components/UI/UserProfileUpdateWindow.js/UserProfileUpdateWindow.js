...
const UserProfileUpdateWindow = (props) => {
  ...
  return (
    <Modal isOpen={props.isOpen} onClose={props.onClose} title="更新资料">
      <Form onSubmit={onSubmit} className="py-4">
        <div className="flex justify-start">
          <Label name="name" className="mr-4 min-w-[4rem]" errorClassName="">
            昵称:
          </Label>
        ...
        <Submit className="mx-auto rw-button rw-button-blue mt-8">保存</Submit>
      </Form>
    </Modal>
  )
}
